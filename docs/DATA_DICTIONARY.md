...
| `ua_category` | the family's category: `browser`, `search`, `ai_crawler` (corpus builders), `ai_fetcher` (the `*-User` on-demand agents), `seo`, `library`, `headless`, `social`, `monitor`, `synthetic`, `other` |
